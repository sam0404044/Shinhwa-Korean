...
const heroSlides = [
  assetPath('/assets/images/hero/hero-kdog-landing-desktop.png'),
  assetPath('/assets/images/content/01.png'),
  assetPath('/assets/images/content/02.png'),
  assetPath('/assets/images/content/03.png'),
  assetPath('/assets/images/content/04.png'),
];
...
const testimonials = [
  { image: assetPath('/assets/images/testimonials/avatar-01.png'), text: '學員見證 1' },
  { image: assetPath('/assets/images/testimonials/avatar-02.png'), text: '學員見證 2' },
  { image: assetPath('/assets/images/testimonials/avatar-03.png'), text: '學員見證 3' },
  { image: assetPath('/assets/images/testimonials/avatar-01.png'), text: '學員見證 4' },
  { image: assetPath('/assets/images/testimonials/avatar-02.png'), text: '學員見證 5' },
];
...
const reasons = [
  {
    ...
    images: [assetPath('/assets/images/testimonials/avatar-01.png'), assetPath('/assets/images/testimonials/avatar-02.png'), assetPath('/assets/images/testimonials/avatar-03.png')],
  },
  {
    title: '最完整！步步精通的全面課程',
    text: '神話韓語從發音、初級、中級到高級，課程完整，加開旅遊會話、檢定考試、速成密集等主題課程，跟著神話韓語，之後能看懂韓文、與韓國人真實對話，甚至長居韓國。',
    images: [assetPath('/assets/images/courses/01.png')],
  },
  {
    title: '最持久！滿滿成就的學習體驗',
    text: '神話韓語的學員能克服學語言兩大障礙：沒有太多時間、缺乏成就無法持久。我們的課程根據大腦、心理研究分堂、分節，設計高效練習，學員始終保持活力，逐步精通韓語。',
    images: [assetPath('/assets/images/courses/02.png')],
  },
  {
    title: '最入心！念念不忘的高效系統',
    text: '神話韓語獨家教材，精巧介面讓您快速了解韓語，每個例句乃至每次練習，都讓您更熟練韓語、了解韓國。線上學習自由安排時間，就算只有一點點時間，也能逐漸精通韓語。',
    images: [assetPath('/assets/images/courses/03.png')],
  },
  {
    title: '最感動！時時有您的親切陪伴',
    text: '神話韓語開設學員專屬群組，可以提出學習問題，也可以交流韓國體驗。人生，要轟轟烈烈追求夢想，現在就給自己勇氣學韓語，您心動，我們陪您一起心動，一起創造感動。',
    images: [assetPath('/assets/images/courses/04.png')],
  },
];
      ...
      <section className="section section-news dots-decor" id="news">
        <div className="container">
          <Link href="/news" className="news-card">
            ...
            <div className="news-card__illus" style={{ backgroundImage: `url('${assetPath('/assets/images/content/news.png')}')` }} />
          </Link>
